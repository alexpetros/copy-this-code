...
# On a fresh install, I typically just `cat ubuntu-setup.sh | ssh root@YOUR_VPS_IP`
...
export SERVICE_NAME="my-rust-service"
export SERVICE_DOMAIN="example.com"
export EXECUTEABLE_NAME="my-rust-service"
...
# Install packages
apt-get -y install gcc openssl nginx rustup make sqlite3
...
echo "export PATH=\$PATH:/home/$RUNAS_USER/.cargo" >> /home/$RUNAS_USER/.profile
...
ExecStart=/home/$RUNAS_USER/.cargo/bin/$EXECUTEABLE_NAME

[Install]
WantedBy=multi-user.target
EOF

# Login to $RUNAS_USER, and set up the environment,
...
ln -s /var/log/$SERVICE_NAME/ logs
